...
MODULE_SCREENSHOTS = {
    ...
    'kw_email_validation_contacts': {
        ...
        'manual_validation': (
            '../docs/images/contacts_module/manual_validation.png'
        ),
    },
    ...
    'kw_email_validation_event': {
        'registrations_list': (
            '../docs/images/event_module/registrations_list.png'
        ),
        'registration_form': (
            '../docs/images/event_module/registration_form.png'
        ),
    },
    'kw_email_validation_hr_recruitment': {
        'applicants_list': (
            '../docs/images/recruitment_module/applicants_list.png'
        ),
        'applicant_form': (
            '../docs/images/recruitment_module/applicant_form.png'
        ),
    },
    'kw_email_validation_mass_mailing': {
        'mailing_contacts_list': (
            '../docs/images/mass_mailing_module/mailing_contacts_list.png'
        ),
        'mailing_contact_form': (
            '../docs/images/mass_mailing_module/mailing_contact_form.png'
        ),
    },
...
def update_readme(module_path, module_name):
    ...
    for name, path in MODULE_SCREENSHOTS[module_name].items():
        ...
        if not os.path.exists(os.path.join(module_path, rel_path)):
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Оновлення README файлів модулів валідації email'
    )
    parser.add_argument(
        '--base-dir',
        default=(
            '/home/vovik/odoo_dev/addons16/repositories/'
            'kitworks-systems/email-validation'
        ),
